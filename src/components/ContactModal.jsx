...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-auto max-h-[90vh] overflow-y-auto fade-in-up p-6">
        {/* Header */}
        ...
        {/* Form */}
        <form name="contact-modal" method="POST" data-netlify="true" onSubmit={handleSubmit} className="p-6 space-y-4">
